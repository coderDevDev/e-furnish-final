      ...
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          <motion.h2
            ...
            className={cn([
              ...
              'text-4xl lg:text-[64px] lg:leading-[64px] mb-5 lg:mb-8 text-muted'
            ])}>
          ...
          <motion.p
            ...
            designed to enhance your space and reflect your unique style.
          </motion.p>
          <motion.div
            initial={{ y: '100px', opacity: 0 }}
            whileInView={{ y: '0', opacity: 1 }}
            ...
            <Link
              ...
              hover:animate-pulse bg-primary">
              Shop Now
            </Link>
          </motion.div>
          {/* <motion.div
        ...
        <motion.section
          ...
          className="relative md:px-4 min-h-[448px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat
           bg-[url('/images/heroBanner.jpg')] 
           md:bg-[url('/images/heroBanner.jpg')]
          ...
          <Image
            ...
            width={56}
            alt="small star"
            className="text-primary absolute left-7 md:left-0 top-36 sm:top-64 md:top-44 lg:top-56 max-w-11 max-h-11 md:max-w-14 md:max-h-14 animate-[spin_3s_infinite]"
          />
        </motion.section>
      </div>
    </header>
